package com.qait.training.report;
...
public class CustomReport extends MyReporterListenerAdapter {
	...
	protected PrintWriter createWriter(String outdir) throws IOException {
		...
		return new PrintWriter(new BufferedWriter(new FileWriter(new File(outdir,"New_emailable-report.html"))));
	}
...
*/
	...
	public void generateSuiteSummaryReport(List<ISuite> suites) {
		m_out.println("<center> Sample Project </center>");
		m_out.println("<br/>");
	...
	private void tableStart(String cssclass, String id) {
		m_out.println("<center><table cellspacing=\"0\" cellpadding=\"0\""
				+ (cssclass != null ? " class=\"" + cssclass + "\"" : " style=\"padding-bottom:2em\"")
				+ (id != null ? " id=\"" + id + "\"" : "") + "></center>");
		m_row = 0;
	}
	...
	protected void startHtml(PrintWriter out) {
		...
		out.println("table {margin-bottom:10px;margin-left:0px;table-align:center;border-collapse:collapse;empty-cells:show}");
		out.println("td,th {border:3px solid #009;padding:.25em .5em}");
		...
		out.println(".passedodd td {background-color: #52BE80}");
